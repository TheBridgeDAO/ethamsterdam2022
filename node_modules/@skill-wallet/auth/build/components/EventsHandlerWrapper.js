...
export var EventsHandlerWrapper = function (_a) {
    var children = _a.children;
    var dispatch = useDispatch();
    useEffect(function () {
        var onActivateCommunity = function (_a) {
            var detail = _a.detail;
            return __awaiter(void 0, void 0, void 0, function () {
                var communityAddr, partnersAddr, partnerKey, comm, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            communityAddr = detail.communityAddr, partnersAddr = detail.partnersAddr, partnerKey = detail.partnerKey;
